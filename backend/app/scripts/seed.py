...
def main() -> None:
    try:
        ...
        with Session(engine) as session:
            seed_all(session)
        print("Seeded use cases plus Fraud Detection, Credit Risk, Document OCR, Support Chatbot, Liquidity Forecast, AML Monitoring, KYC/KYB, Email Automation, and Market Intelligence raw datasets.")
